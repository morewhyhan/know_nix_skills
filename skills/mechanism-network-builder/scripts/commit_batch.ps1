...
$script = Join-Path $PSScriptRoot 'commit_batch.py'
$candidates = @()
...
if ($candidates.Count -eq 0) { throw 'No usable Python 3 runtime found.' }

$env:PYTHONUTF8 = '1'
[Console]::OutputEncoding = [System.Text.UTF8Encoding]::new()
& $candidates[0] $script --root $Root --staging $Staging
exit $LASTEXITCODE
